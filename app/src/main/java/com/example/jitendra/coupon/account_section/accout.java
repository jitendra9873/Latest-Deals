package com.example.jitendra.coupon.account_section;
...
import static com.example.jitendra.coupon.account_section.Edit.MY_PREFS_NAME;

public class accout extends AppCompatActivity {
...
/*        add = (TextView) findViewById(R.id.address);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.edit_menu:
                Intent intent = new Intent(accout.this, Edit.class);
                startActivity(intent);
                finish();
                return true;
        }
