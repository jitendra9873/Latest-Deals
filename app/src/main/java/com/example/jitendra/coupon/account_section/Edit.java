...
public class Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mspinner = (NoDefaultSpinner) findViewById(R.id.spinner);
                    ...
                    if ((mlname.getText().toString().matches(""))) {
                        ...
                        if (!isValidEmail(memail.getText().toString())) {
                            ...
                            if (!isValidMobile(mmno.getText().toString())) {
                                ...
                                editor.commit();
                                Intent intent = new Intent(Edit.this, accout.class);
...
//                .show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent myIntent = new Intent(getApplicationContext(), accout.class);
